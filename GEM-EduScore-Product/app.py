...
def inject_styles() -> None:
    st.markdown(
        ...
        .hero h1 {
            ...
            margin: 1.15rem 0 1.05rem; letter-spacing: -.058em; font-weight: 900;
        ...
        .gradient-word {
            ...
            text-shadow: 0 10px 28px rgba(79,70,229,.14);
        }
        .gradient-word::after {
            content: ""; position: absolute; left: .03em; right: .01em; bottom: -.08em;
            height: .075em; min-height: 4px; border-radius: 999px;
            background: linear-gradient(90deg, #4f46e5, #7c3aed 58%, #0f9f8f);
            opacity: .82;
        }
        .hero-copy { max-width: 850px; font-size: 1.02rem; line-height: 1.72; margin: 0; }
        .hero-orbit {
...
def render_brand() -> None:
    ...
    st.markdown(
        ...
        <div class="brand-row">
            ...
            <div class="version-pill">iGEM SHOWCASE · V0.10.0</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
def main() -> None:
    ...
    workspace_column, history_column = st.columns([4.8, 1.2], gap="medium", vertical_alignment="center")
    with history_column:
